Feature: Get Single User
  ...
  Scenario: Get single user with valid parameter id and token
    Given Get single user with valid parameter id 1830740 and token
    When Send get single users
    Then Status code should be 200 OK
    And Response body id should be id 1830740
  ...
  Scenario: Get single user with valid parameter id and invalid token
    Given Get single user with valid parameter id 1830740 and invalid token
    When Send get single users
